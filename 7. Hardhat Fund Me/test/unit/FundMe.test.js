...
describe("FundMe", function () {
    ...
    describe("withdraw", function () {
        ...
        it("allows to withdraw with multiple funders", async function () {
            ...
            for (let i = 0; i < fundMe.funders.length; i++) {
                const address = fundMe.funders[i];
                const accountBalance = await fundMe.addressToAmountFunded(
                    address
                );
        ...
        it("only allows the owner to withdraw", async function () {
            ...
            await expect(fundMeAttackerContract.withdraw()).to.be.revertedWith("FundMe__NotOwner");
        });
    });
});
